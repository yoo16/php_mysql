...
<body>
    <div class="container">
        ...
        <form action="confirm.php" method="post">
            ...
            <p class="text-danger"><?= @$member->errors['name'] ?></p>
            ...
            <p class="text-danger"><?= @$member->errors['email'] ?></p>

            <label for="">パスワード</label>
            <input type="password" class="form-control" name="password" value="">
            <p class="text-danger"><?= @$member->errors['password'] ?></p>

            <label for="">電話番号（ハイフンなし）</label>
            <input type="text" class="form-control" name="tel" value="<?= $member->value['tel'] ?>">
            <p class="text-danger"><?= @$member->errors['tel'] ?></p>
